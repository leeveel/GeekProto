...
{
    public class LinkedListFormatter<T> : ISerializeFormatter<LinkedList<T>>
    {
        public LinkedList<T> Deserialize(Span<byte> buffer, ref int offset)
        {
        ...
        public void Serialize(Span<byte> buffer, LinkedList<T> value, ref int offset)
        {
            if (value == null)
            {
        ...
        public int GetSerializeLength(LinkedList<T> value)
        {
            if (value == null)
