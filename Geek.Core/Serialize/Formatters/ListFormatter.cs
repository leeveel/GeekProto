...
{
    public class ListFormatter<T> : ISerializeFormatter<List<T>>
    {
        public List<T> Deserialize(Span<byte> buffer, ref int offset)
        {
        ...
        public void Serialize(Span<byte> buffer, List<T> value, ref int offset)
        {
            if (value == null)
            {
        ...
        public int GetSerializeLength(List<T> value)
        {
            if (value == null)
